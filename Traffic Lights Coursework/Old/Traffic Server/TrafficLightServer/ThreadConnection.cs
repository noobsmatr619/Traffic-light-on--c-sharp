        ...
        public void run()
        {
            ...
            try
            {
                ...
                while (running)
                {
                    ...
                    String message = remoteIP + " " + stringFromServer;

                    Console.WriteLine(message + "\n");

                    //**************************************************************//
                    // Post the message we have received back to the form.  Posting //
                    // messages to ourself. The significance is that the messages   //
                    // come back in the form's main thread.                         //
                    //**************************************************************//
            ...
            catch (Exception err)
            {
                ...
                Console.Out.WriteLine("Error caused by " + err.Message);
                running = false;
            }
        }
